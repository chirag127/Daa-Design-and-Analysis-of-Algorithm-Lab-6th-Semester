...
N Queen Problem using Backtracking: Implement a backtracking algorithm to find all possible solutions to the n-queens problem, which is to place n queens on an nxn chessboard such that no two queens attack each other.
 Here's a sample C code to solve the N-Queen problem using backtracking:
...
prints the placement of queens in the form of an 
array. Please note that there may be more than 
one solutions, this function prints one of the 
feasible solutions.*/
bool solveNQ() 
{ 
